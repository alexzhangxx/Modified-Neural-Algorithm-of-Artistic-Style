...
def const_vgg_net(input_image, layer_list):
    ...
    fc6 = const_fc_layer(pool5,layer_list[48:50], in_size, 4096, "fc6")  # 25088 = ((224 // (2 ** 5)) ** 2) * 512
    relu6 = tf.nn.relu(fc6) 

    fc7 = const_fc_layer(relu6,layer_list[50:52], 4096, 4096, "fc7")
    relu7 = tf.nn.relu(fc7)

    fc8 = const_fc_layer(relu7,layer_list[52:54], 4096, 10, "fc8")
...
def vgg_net(input_image):
    ...
    fc8, w19 = fc_layer(relu7, 4096, 10, "fc8")
    ...
    layer_list.append(w17[0])
    layer_list.append(w17[1])
    
    layer_list.append(w18[0])
    layer_list.append(w18[1])
    
    layer_list.append(w19[0])
    layer_list.append(w19[1])

    return fc8, prob, layer_list
