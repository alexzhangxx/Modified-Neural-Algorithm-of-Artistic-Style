...
CONTENT_LAYERS = ( 'relu2_2', 'relu2_1')
...
def stylize(initial, initial_noiseblend, content, styles, preserve_colors, iterations,
    ...
    with g_net.as_default():
        ...
        content_layers_weights['relu2_1'] = 0.5
        content_layers_weights['relu2_2'] = 0.5
        content_layers_weights['relu3_1'] = 0.0
        content_layers_weights['relu3_2'] = 0.0
        content_layers_weights['relu4_1'] = 0.0
        content_layers_weights['relu4_2'] = 0.0
        ...
        tv_loss = tv_weight * 2 * (
                ...
                (tf.nn.l2_loss(image[:,:,1:,:] - image[:,:,:shape[2]-1,:]) /
                    tv_x_size))
        # overall loss
        loss = content_loss + style_loss + 0.00001* tv_loss
        #loss = content_loss
