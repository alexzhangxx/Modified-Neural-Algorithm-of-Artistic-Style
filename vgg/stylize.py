...
def stylize(initial, initial_noiseblend, content, styles, preserve_colors, iterations,
    ...
    with g_net.as_default():
        ...
        net = const_vgg_net(image, layer_list)
        
        # content loss
        content_layers_weights = {}
        content_layers_weights['relu1_1'] = 0
        content_layers_weights['relu2_1'] = 0
        content_layers_weights['conv1_1'] = 0
        content_layers_weights['conv2_2'] = 0
        content_layers_weights['conv3_1'] = 0
        content_layers_weights['conv3_2'] = 0
        content_layers_weights['conv4_2'] = 1.0
        content_layers_weights['conv5_2'] = 1.0
        content_layers_weights['relu4_2'] = 10.0
        content_layers_weights['relu5_2'] = 10.0
        ...
        with tf.Session() as sess:
            ...
            for i in range(iterations):
                ...
                if (checkpoint_iterations and i % checkpoint_iterations == 0) or last_step:
                    ...
                    img_out = image.eval().reshape(shape[1:])
